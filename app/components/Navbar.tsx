                ...
                <>
                                ...
                                <div className="flex items-center">
                                    <Link href="/">
                                        <h1 className="text-2xl font-medium">
                                            Thanon <span className="text-teal-500"> Marshal </span>
                                        </h1>
                                    </Link>
                                </div>
                    ...
                    <Disclosure.Panel className="sm:hidden">
                        <div className="pt-2 pb-3 space-y-1">
                            <Link href="/" prefetch className={`${pathname == "/" ? 'bg-teal-50 border-teal-500 text-teal-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:text-gray-800' 
                            ...
                            <Link 
                            href="/guestbook" prefetch 
                            className={`${pathname == "/guestbook" ? 'bg-teal-50 border-teal-500 text-teal-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:text-gray-800' 
                            : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-teal-500 block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base font-medium dark:text-white'}`}>
                                Guestbook
                            </Link>
                            <Link 
                            href="/project" prefetch 
                            className={`${pathname == "/project" ? 'bg-teal-50 border-teal-500 text-teal-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:text-gray-800' 
                            : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-teal-500 block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base font-medium dark:text-white'}`}>
                                Project
                            </Link>
                        </div>
