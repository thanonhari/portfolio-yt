    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div className="grid gap-y-8 sm:gap-6 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:gap-10 pt-8">
        {data.map((project) =>
            ...
            shadow-lg dark:bg-black dark:shadow-gray-700 shadow-teal-900">
              ...
              <div className="p-4 sm:p-6">
                ...
                <a href={project.link} target="_blank" className="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-emerald-500">
                  Learn More...!
